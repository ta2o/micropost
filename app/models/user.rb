class User < ApplicationRecord
  ...
  has_many :skinships
  has_many :favorites, through: :skinships, source: :like
  has_many :reverses_of_skinship, class_name: 'Skinship', foreign_key: 'like_id'
  has_many :likes, through: :reverses_of_skinship, source: :user
  ...
  def unlike(other_user)
    skinship = self.skinships.find_by(like_id: other_user.id)
